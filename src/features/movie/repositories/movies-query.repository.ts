...
import {MovieFinalOutputModel, MovieOutputModel, MovieOutputModelMapper} from "../models/movie-output.model";
...
export class MovieQueryRepository {
    ...
    async getAllMovies (sortData: QueryMovieInputModel, userId?: string): Promise<MovieFinalOutputModel>{
